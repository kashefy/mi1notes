...
\begin{frame}\frametitle{\subsubsecname}
	...
	\question{What are we interested in decomposable graphs?}\\
...
\question{Is this a chordal graph? i.e. does it contain cycles with 4+ vertices?}\\
		...
		\begin{figure}[h]
		 ...
		 \begin{subfigure}[t]{0.3\textwidth}
			 ...
			 \caption{The cycle CEZX requires a chord for the graph to be chordal.}%
		 \end{subfigure}
