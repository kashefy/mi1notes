...
\captionof{table}{Comparing the cumulative discounted reward for two strategies under different discount factors for the example in \figref{fig:mouse_walk}.}
