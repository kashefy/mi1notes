...
\begin{frame}\frametitle{\secname}
    ...
    \item<4-> A model with tunable parameters $\vec w$: connectionist neuron, MLP,\ldots
    \item<5-> A learning algorithm\mode<article>{ for finding the set of parameters in our model that will minimize the cost function.\\
