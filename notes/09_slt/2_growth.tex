...
\begin{frame}\frametitle{Defining the growth function $G_{(p)}^\Lambda$}
	...
	There is no convergence to zero, regardless of $p$. According to Vapnik, this means that the classifiers predictions become ambiguous and will likely fail to generalize.
