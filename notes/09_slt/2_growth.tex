...
\begin{frame}\frametitle{\subsecname}\label{sec:convergence_erm_revisit}
			...
			The takeaway from the growth function and the bounds is that it defines the value of $\eta$ in \eqref{eq:convergenceeps} that can be targeted when tranining a specific model with a finite set of $p$ points.
