...
\begin{itemize}
\item[(i)]
Simplify assumptions (will be relaxed later)\notesonly{\footnote{This is based on my understanding of Ch. 9 from \citep{scholkopf2001learning} and \citep{scholkopf2000new}}}
...
\footnotesize
        ...
        \begin{equation}
        \min_{\vec w,b} \frac{1}{2} \lVert \vec w \rVert + C \; \overbrace{\frac{1}{p} \sum_{\alpha=1}^p (\varphi_\alpha + \varphi_\alpha^*)}^{=:R^{\varepsilon}_{\text{emp}}(\vec w,b)}
    \end{equation}
\slidesonly{
\endgroup
}
