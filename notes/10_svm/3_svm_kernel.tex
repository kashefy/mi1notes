...
\notesonly{
The feature space is transformed into a new space in which the classes can become linearly seperable:
}
			\begin{equation}
...
\item placing the centroids ontop of the support vectors,
