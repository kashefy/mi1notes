...
\notesonly{We therefore constrain solutions such that:}
\slidesonly{Constraint:}
...
\notesonly{
This gives us the \emph{primal} problem for structured risk minimization (SRM) prooblem. }
...
\begin{figure}[h]
    \centering
    \includegraphics[height=2cm]{img/scale} 
    \mode<article>{
    \caption{
