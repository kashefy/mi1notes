...
\begin{textblock}{5}(12.5,15)
$\mbox{\tiny-\{+1*0.2-1\} = +0.8 > 0}$
\end{textblock}
\begin{textblock}{5}(9,10)
$\mbox{\tiny-\{+1*(-11)-1\} = +12 > 0}$
\end{textblock}
}}
	\mode<article>{
\begin{figure}[ht]
...
\\ \hline
on       & $\mbox{\scriptsize-1}$                                & $\mbox{\scriptsize-1}$                                                         & yes                                                            & $\mbox{\scriptsize-\{-1 * (-1) - 1\} = 0}$                              & \begin{tabular}[c]{@{}c@{}}{\color[HTML]{CB0000} met with}\\ {\color[HTML]{CB0000}equality}\end{tabular}
\end{tabular}
\end{table}
\end{frame}
