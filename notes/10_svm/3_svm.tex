...
\begin{frame}\frametitle{\subsecname~applied to binary classification}
...
\visible<3->{
\svspace{5mm}
\slidesonly{Constraint for correct classification (modified ``\emph{0-1 loss}'' or ``\emph{hinge loss}'') \underline{and} \textbf{not} inside the margin:}
