...
\begin{frame}
    ...
    \begin{figure}[h]
        ...
        \caption{The hyperplane \protect{$\color{red}H = \{\vec x : \vec w^{\top} \vec x = \theta \}$} that divides the response of the neuron. In the context of classification it is referred to as the decision boundary.}
