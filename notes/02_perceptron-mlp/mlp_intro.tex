...
\begin{figure}[ht]
    \centering
	\includegraphics[width=0.6\textwidth]{img/build_xor}
...
\begin{figure}[ht]
     \centering
     \savebox{\imagebox}{
	 \includegraphics[width=0.3\textwidth]{img/xor_decision}}%
	...
	\caption{simplified MLP architecture for the XOR problem}
